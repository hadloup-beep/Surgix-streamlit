...
# ═══════════════════════════════════════════════════════════════
st.set_page_config(
    page_title="SURGIX v1.09 Sunrays",
    page_icon="🏥",
    layout="wide",
...
def page_login():
    ...
    with col2:
        ...
        <div style="text-align:center; padding:40px 0 20px 0;">
            ...
            <p style="color:#90A4AE; font-size:0.75rem;">v1.09 Sunrays · Service Ophtalmologie</p>
        </div>
        """, unsafe_allow_html=True)
...
def render_header(subtitle=""):
    ...
    <div class="surgix-header">
        <div style="font-size:2rem;">🏥</div>
        <div>
            <h1>SURGIX&nbsp;&nbsp;<span style='font-size:0.9rem;color:#90CAF9;'>v1.09 Sunrays</span></h1>
...
{f["med"]} &nbsp;•&nbsp; SURGIX v1.09 Sunrays</div>
</body></html>"""
